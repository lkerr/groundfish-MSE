                    ...
                    do.fit = TRUE, save.sdrep=TRUE)
{
  ...
  if(do.fit){
    ...
    print("Before fit_tmb")
    mod <- wham:::fit_tmb(mod, n.newton = n.newton, do.sdrep = FALSE, do.check = do.check, save.sdrep = save.sdrep)
    print("After fit_tmb")
...
environment(fit_wham) <- asNamespace("wham")