...
get_bio_for_econ_only=function(stock,basecase){
  ...
  biocontain$nonsector_catch_mt<-0 #this is a placeholder so Id on't need to rewrite other things
  biocontain$sectorACL<-biocontain$sectorACL_mt
