...
#' \itemize{
#'   \item{dat.use - data used in the Plan B approach}
#'   \item{lfit - Loess smoother applied to data}
#'   \item{pred_fit - predicted values from loess smoother}
#'   \item{reg.use - last three values from pred_fit}
#'   \item{llr_fit - log linear regression of last three loess predicted values}
#'   \item{multiplier - multiplier used for catch advice}
#'   \item{tsplot - plot of Biomass index}
#' }
#' 
