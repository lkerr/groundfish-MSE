...
get_WHAM <- function(stock,...){
  ...
  out <- within(stock, {
    ...
    print("convergence")
    print(whamConverge)
    print(wham_storage$checkConvergence[[r]][[y]])
  ...
  wham_storage$Catch[[r]][[y]] <- whamEst$rep$pred_catch
  wham_storage$CAA[[r]][[y]] <- whamEst$rep$pred_CAA[,1,]
  wham_storage$FMSY[[r]][[y]] <- whamEst$rep$log_FXSPR_static
  wham_storage$SSBMSY[[r]][[y]] <- whamEst$rep$log_SSB_FXSPR_static
  wham_storage$MSY[[r]][[y]] <- whamEst$rep$log_Y_FXSPR_static
