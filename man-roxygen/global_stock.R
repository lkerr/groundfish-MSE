...
#' @param stock A storage object containing initial stock parameters (stockPar generated by runSetup) and storage for each stock's simulation results (stockCont generated by get_containers). For multiple stocks this is a list of lists.
