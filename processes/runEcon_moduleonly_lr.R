...
# Update choice_prev_fish
    ...
    working_targeting[spstock2=="americanlobster", exp_rev_total:=exp_rev_total*lobster_rescale]
    working_targeting[spstock2=="americanlobster", actual_rev_total:=actual_rev_total*lobster_rescale]
    working_targeting[spstock2=="americanlobster", exp_rev_total_das:=exp_rev_total_das*lobster_rescale]
    working_targeting[spstock2=="americanlobster", actual_rev_total_das:=actual_rev_total_das*lobster_rescale]
