...
1. MP1 - Slide HCR. Economic model with economic "years" randomly drawn from 2010 to 2015.  I draw a entire years.
2. MP2 - Slide HCR.  Economic model with all economic parameters (prices, daily weather, catch limits and trawl index, costs) equal to their 2015 actual values.  
3. MP3 -- Slide HCR.  Standard fisheries model with zero implementation error. 
4. MP4 -- Slide HCR. Standard fisheries model with two implementation error parameters internally estimated from model 1.
5. MP5 - Constant F HCR. Economic model with economic "years" randomly drawn from 2010 to 2015.  I draw a entire years.
6. MP6 - Constant F HCR. Standard fisheries model with two implementation error parameters internally estimated from **model 1**.
7. MP7 - Constant F HCR. Standard fisheries model with two implementation error parameters internally estimated from model 5.
